...
struct ComparadorPacientes {
    bool operator()(const Paciente& a, const Paciente& b) const {
        ...
        if (tiempoA != tiempoB) {
            ...
            return a.nivelUrgencia > b.nivelUrgencia; // Priorizar menor nivel de urgencia
        }
    }
};
...
// Implementación de los métodos de ColaDePrioridad

void ColaDePrioridad::cargarPacientes() {
    vector<Paciente> pacientes = {
        {"Pedro", 36, true, "Hernandez", 1, "25/11/2024", "08:00"},
        {"Mariana", 9, true, "Torres", 2, "25/11/2024", "08:00"},
        {"Carlos", 36, true, "Carvajal", 1, "25/11/2024", "09:00"},
        {"Daniela", 36, true, "Hernandez", 2, "25/11/2024", "09:30"},
        {"Luis", 18, true, "Torres", 2, "25/11/2024", "10:00"},
        {"Andrea", 29, true, "Carvajal", 1, "25/11/2024", "10:30"},
        {"Mauricio", 45, true, "Hernandez", 3, "25/11/2024", "11:00"},
        {"Roberto", 52, true, "Torres", 1, "25/11/2024", "11:30"},
        {"Jonathan", 25, true, "Torres", 3, "25/11/2024", "12:00"},
        {"Isabel", 19, true, "Carvajal", 2, "25/11/2024", "12:30"},
        {"Valeria", 31, true, "Hernandez", 2, "25/11/2024", "13:00"},
        {"Laura", 6, true, "Hernandez", 4, "25/11/2024", "13:30"},
        {"Ana", 33, true, "Torres", 4, "25/11/2024", "14:00"},
        {"Miguel", 50, true, "Carvajal", 1, "25/11/2024", "14:30"},
        {"Tomas", 36, true, "Hernandez", 5, "25/11/2024", "15:00"},
        {"Sara", 12, true, "Torres", 5, "25/11/2024", "15:30"},
        {"Carmen", 40, true, "Carvajal", 2, "25/11/2024", "16:00"}
    };
...
void ColaDePrioridad::reasignarPacientes() {
...
void ColaDePrioridad::construirColaPacientes() {
...
void ColaDePrioridad::atenderPacientes() {
    int orden = 1;
...
void ColaDePrioridad::mostrarPacientesAtendidos() const {
